...
import 'package:AbdullahAsadF/models/epic.dart';
import 'package:AbdullahAsadF/view/mp3_player.dart';
                            ...
                            builder: (context, snapshot) {
                              ...
                              return SliderTheme(
                                data: SliderTheme.of(context).copyWith(
                                  ...
                                  activeTrackColor: UtilColours.APP_BAR,
        ...
        itemBuilder: (BuildContext context, int index){
          ...
          return Container(
            ...
            child: ListTile(
                ...
                leading: new Icon(entry.type == "RECORD" ? Icons.description : Icons.menu, color: UtilColours.APP_BAR),
                // subtitle:  Container(
                //   child: Column(
